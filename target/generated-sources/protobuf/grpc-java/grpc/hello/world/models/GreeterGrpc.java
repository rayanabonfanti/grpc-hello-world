...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "grpc.hello.world.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<grpc.hello.world.models.HelloRequest,
      grpc.hello.world.models.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = grpc.hello.world.models.HelloRequest.class,
      responseType = grpc.hello.world.models.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.hello.world.models.HelloRequest,
      grpc.hello.world.models.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<grpc.hello.world.models.HelloRequest, grpc.hello.world.models.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<grpc.hello.world.models.HelloRequest, grpc.hello.world.models.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.hello.world.models.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.hello.world.models.HelloReply.getDefaultInstance()))
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(grpc.hello.world.models.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.hello.world.models.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public grpc.hello.world.models.HelloReply sayHello(grpc.hello.world.models.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.hello.world.models.HelloReply> sayHello(
        grpc.hello.world.models.HelloRequest request) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc.hello.world.models.HelloRequest,
              grpc.hello.world.models.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.hello.world.models.HelloWorld.getDescriptor();
    }
